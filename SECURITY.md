...
If the report is out of scope, a member of the `jito-foundation/admins` group will
...
Compensation for duplicative reports will be split among reporters with first to report taking priority using the
following equation
