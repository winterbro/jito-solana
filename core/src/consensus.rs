...
impl Tower {
    ...
    pub fn record_bank_vote(&mut self, bank: &Bank, pop_expired: bool) -> Option<Slot> {
        ...
        self.record_bank_vote_and_update_lockouts(bank.slot(), bank.hash(), block_id, pop_expired)
    }
    ...
    pub fn record_vote(&mut self, slot: Slot, hash: Hash) -> Option<Slot> {
        self.record_bank_vote_and_update_lockouts(slot, hash, Hash::default(), true)
    }
